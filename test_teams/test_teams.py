...
from mlb_statsapi.client import MLBStatsAPIError, MLBStatsClient
from mlb_statsapi.teams import get_teams, MLB_SPORT_ID
...
class TestGetTeams(unittest.TestCase):
    ...
    def test_creates_default_client_when_none_provided(self):
        ...
        with patch("mlb_statsapi.teams.MLBStatsClient") as MockClient:
            ...
            with patch("mlb_statsapi.teams.MLBStatsClient") as MC:
